...
// Plant = '1 & 2', Floor = '2' — single bridge sensor connecting both plants.
const MAP_SENSORS = [
    ...
    <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
      <div style={{ padding: "16px 20px 14px", borderBottom: "1px solid #e9ecef", flexShrink: 0 }}>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Plant 1 and 2 Floor 2 · Each sensor has its own threshold
          {hasChanges && (
    ...
    <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
      ...
      <div style={{ padding: "16px 20px 14px", borderBottom: "1px solid #e9ecef", flexShrink: 0 }}>
        ...
        <p className="text-sm text-muted-foreground mt-0.5" style={{ display: "flex", alignItems: "center", gap: 8 }}>
          Bridge · {activeCount} active, {inactiveCount} inactive
          {hasChanges && !saving && (
